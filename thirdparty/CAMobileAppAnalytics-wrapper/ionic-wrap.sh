...
cd "${CA_SDK_DIR}"
#sh ./wrap.sh -a "${_workdir}/${_apkrelativepath}/${APK_NAME}" -p "${CA_AXA_PLIST}" -o "${APK_NAME}"
#sh ./wrap.sh -a "${_workdir}/${_apkrelativepath}/${APK_NAME}" -p "${CA_AXA_PLIST}" -o "${APK_NAME}" -v -r -n
