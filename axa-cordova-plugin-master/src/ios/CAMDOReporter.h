/*
 *
 * Copyright (c) 2013-2017 CA Technologies
 * All rights reserved.
 *
 */
...
/* Call this method to provide general feedback from the user.  The feedback is tagged ot the current session
 */
+ (void) setUserFeedback:(NSString *) feedback;
 ...
 */
+ (void) setCrashFeedback:(NSString *) feedback;
